...
import com.medical.appointment.model.vo.AppointmentsVO;
...
public class AppointmentController {
    ...
    public Result<AppointmentVO> createAppointment(
        ...
        log.info("Received POST request to create appointment. User ID: {}", userId);
    ...
    public Result<AppointmentsVO> listAppointments(
        ...
        vo.setAppointments(appointmentList);
        if(CollectionUtil.isNotEmpty(appointmentList)){
            vo.setNextCursor(appointmentList.get(appointmentList.size()-1).getEndAt().toString());
        }
